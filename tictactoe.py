...
#now we declare a function that checks whether a player has one or not

def check_win(): #this function checks whether there are 3 consecutive marks of the same symbol in the row, column or diagonally after every entry
